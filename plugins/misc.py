...
async def who_is(client, message):
    ...
    if from_user is None:
        return await status_message.edit("Aucun identifiant utilisateur valide / message spécifié")
    ...
    dc_id = from_user.dc_id or "[L'utilisateur n'a pas de DP valide]"
...
async def imdb_search(client, message):
    if ' ' in message.text:
        ...
        await message.reply('Donne-moi le nom d\'un film / série')
